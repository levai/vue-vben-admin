...
| 技术            | 版本   | 用途     | 说明               |
| --------------- | ------ | -------- | ------------------ |
| **Spring Boot** | 2.7.18 | 核心框架 | 企业级应用开发框架 |
| **Java**        | 11     | 编程语言 | LTS 版本，稳定可靠 |
...
| **MyBatis Plus** | 3.5.9  | ORM 框架     | 增强 MyBatis，简化 CRUD |
| **Druid**        | 1.2.16 | 数据库连接池 | 监控、统计、SQL 防火墙  |
...
| 技术                | 版本   | 用途       | 配置           |
| ------------------- | ------ | ---------- | -------------- |
| **Spring Security** | 2.7.18 | 安全框架   | JWT 无状态认证 |
| **JWT (jjwt)**      | 0.7.0  | Token 认证 | HS512 签名算法 |
...
| 技术        | 版本  | 用途     | 特性             |
| ----------- | ----- | -------- | ---------------- |
| **Knife4j** | 3.0.3 | API 文档 | 基于 Swagger 3.0 |

**Swagger 注解规范**：

- Controller 类：`@Api(tags = "...")`（Springfox）
...
| **JAXB API**               | 2.3.1 | XML 绑定     | Java 11+ 需要单独添加 |
...
1. **成熟稳定**：Spring Boot 2.7.18 + Java 11（LTS 版本）
