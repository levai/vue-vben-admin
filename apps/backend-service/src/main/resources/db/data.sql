...
INSERT INTO `sys_user` (`id`, `username`, `password`, `real_name`, `status`, `home_path`, `deleted`) VALUES
('1', 'admin', '{bcrypt}$2a$10$JD2zdYaU9CFJ7rG6jisYmepsfAG..pCvV0SWxqNoJuL9NwQTAOOVy', '管理员', 1, '/dashboard', 0);
